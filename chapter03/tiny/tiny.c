...
void doit(int fd);
void read_requesthdrs(rio_t *rp, char *request_buf);
...
void write_requesthdrs(int fd, char *buf);
...
void doit(int fd)
{
    ...
    read_requesthdrs(&rio, request_buf); // line:netp:doit:readrequesthdrs
    write_requesthdrs(output_file, request_buf);
